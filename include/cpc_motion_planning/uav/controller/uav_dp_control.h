...
public:
  ...
  {
    S_A_horizontal = static_cast<CUDA_MAT::Matrix<3,UAVModel::Input>*>(factory.load_cuda_matrix<3,UAVModel::Input>("/home/joseph/yzchen_ws/UAV/nndp_data/uav-slow/SA.dat",load_to_host));
    S_A_vertical = static_cast<CUDA_MAT::Matrix<3,UAVModel::Input>*>(factory.load_cuda_matrix<3,UAVModel::Input>("/home/joseph/yzchen_ws/UAV/nndp_data/uav-slow/SA.dat",load_to_host));
    factory.load_uniform_bin("/home/joseph/yzchen_ws/UAV/nndp_data/uav-slow/pos_bin.dat",ubc.bins[0]);
    factory.load_uniform_bin("/home/joseph/yzchen_ws/UAV/nndp_data/uav-slow/vel_bin.dat",ubc.bins[1]);
    factory.load_uniform_bin("/home/joseph/yzchen_ws/UAV/nndp_data/uav-slow/acc_bin.dat",ubc.bins[2]);
  }
